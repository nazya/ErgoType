...
#if 0
/*
 * CM6533 jack control depends on .raw_event and HID_CONNECT_HIDDEV_FORCE.
 * Keep this upstream block disabled until raw_event/hiddev ownership is wired.
 */
...
static const struct hid_driver cmhid_hs100b_driver = {
	.name = "cmedia_hs100b",
...
#if 0
/*
 * Upstream registers both CM6533 and HS100B drivers from one module_init().
 * The port enables only HS100B because CM6533 needs raw_event/hiddev.
 */
...
module_hid_driver(cmhid_hs100b_driver);
