...
static const struct hid_device_id hid_quirks[] = {
	...
	/*
	 * Firmware boundary: keep these unfinished USB profiles aligned with the
	 * compile-gated fixed Wacom rows. The upstream quirk path lets unchanged
	 * hid-generic bind instead of letting the final Wacom wildcard claim them.
	 * The broad development configuration restores upstream Wacom matching.
	 */
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0000), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0003), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0010), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0011), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0012), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0013), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0014), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0015), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0016), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0017), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0018), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0019), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0020), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0021), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0022), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0023), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0024), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0026), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0028), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x002a), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0030), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0031), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0032), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0033), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0034), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0035), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0037), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0038), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0039), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x003f), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0041), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0042), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0043), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0044), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0045), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0047), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0057), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0059), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x005b), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x005d), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x005e), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0060), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0061), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0062), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0063), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0064), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0065), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0069), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x006a), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x006b), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0090), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0093), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0094), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0097), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x009a), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x009f), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b0), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b1), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b2), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b3), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b4), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b5), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b7), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b8), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00b9), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00ba), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00bb), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00bc), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c0), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c2), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c4), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c5), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c6), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00c7), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00cc), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00ce), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d0), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d1), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d2), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d3), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d4), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d5), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d6), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d7), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00d8), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00da), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00db), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00dd), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00df), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00e2), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00e3), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00e5), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00e6), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00ec), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00ed), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00ef), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00f0), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00f4), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00f6), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00f8), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00fa), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x00fb), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0100), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0101), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x010d), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x010e), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x010f), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0116), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x012c), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0300), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0301), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0307), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0309), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x030a), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x030c), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0318), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0319), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0325), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0326), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x032a), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x032b), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x032c), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x032f), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0333), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0335), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0336), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x0343), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x4001), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x4004), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x5000), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
	{ HID_USB_DEVICE(USB_VENDOR_ID_WACOM, 0x5002), HID_QUIRK_IGNORE_SPECIAL_DRIVER },
#endif
...
static const struct hid_device_id hid_have_special_driver[] = {
	...
	// Mirror selected apple_devices[] rows so excluded devices keep generic
	// fallback.
	...
	/* Bluetooth and dock devices are outside the external USB keyboard scope. */
...
// suppress its generic fallback until that upstream table entry is enabled.
	...
	/* SideWinder is outside the selected non-gaming USB driver table. */
...
#if IS_ENABLED(CONFIG_HID_MICROSOFT_ALL_DEVICES)
	/* Bluetooth matching remains disabled with the corresponding driver rows. */
...
bool hid_ignore(struct hid_device *hdev)
{
	...
	case USB_VENDOR_ID_ELAN:
		...
		// 			return true;
		// Port: elan-i2c ACPI id table is not imported; keep these HID devices visible.
		break;
