...
// Firmware exposes this driver's required HID/USB contracts through the
// reduced public hid.h and usb.h; Linux USB-private state is not imported.
...
static const struct hid_driver uclogic_driver = {
	.name = "uclogic",
