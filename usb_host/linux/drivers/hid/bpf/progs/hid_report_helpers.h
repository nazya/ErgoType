...
// 				       "not a i32/u16"))
// RP2040 uses an unsigned 32-bit type for 0xffffffffL; signed 64-bit bounds
// preserve upstream's signed-long comparison for both negative and u32 values.
#define i32(v_) ((__u32)(v_) + must_be((v_) >= -0x80000000LL && (v_) <= 0xffffffffLL, \
				       "not a i32/u16"))
