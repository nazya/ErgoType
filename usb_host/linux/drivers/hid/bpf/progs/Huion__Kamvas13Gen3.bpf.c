...
static const char EXPECTED_FIRMWARE_ID[] = "HUION_M22c_";
...
struct huion_kamvas13_gen3_state {
	__u8 last_button_state;
};
...
int BPF_PROG(hid_fix_event_huion_kamvas13_gen3, struct hid_bpf_ctx *hid_ctx)
{
	...
	struct huion_kamvas13_gen3_state *state = hid_bpf_get_private(hid_ctx);
...
HID_BPF_STATIC_PROGRAM(huion_kamvas13_gen3, probe, sizeof(struct huion_kamvas13_gen3_state),
