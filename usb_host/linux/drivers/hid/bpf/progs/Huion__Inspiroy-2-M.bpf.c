...
static const char EXPECTED_FIRMWARE_ID[] = "HUION_T21k_";
...
struct huion_inspiroy2_m_state {
	__u16 last_button_state;
};
...
int BPF_PROG(inspiroy_2_fix_events, struct hid_bpf_ctx *hctx)
{
	...
	struct huion_inspiroy2_m_state *state = hid_bpf_get_private(hctx);
...
HID_BPF_STATIC_PROGRAM(inspiroy_2, probe, sizeof(struct huion_inspiroy2_m_state),
