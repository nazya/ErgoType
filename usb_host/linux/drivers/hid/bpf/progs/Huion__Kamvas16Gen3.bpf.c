...
#define UDEV_PROP_HUION_FIRMWARE_ID hid_bpf_get_firmware_id(hid_ctx)

// char EXPECTED_FIRMWARE_ID[] = "HUION_M22d_";
// The prefix is immutable and private to this native program.
static const char EXPECTED_FIRMWARE_ID[] = "HUION_M22d_";
...
struct huion_kamvas16_gen3_state {
	__u8 last_button_state;
};
...
int BPF_PROG(hid_fix_event_huion_kamvas16_gen3, struct hid_bpf_ctx *hid_ctx)
{
	...
	struct huion_kamvas16_gen3_state *state = hid_bpf_get_private(hid_ctx);
...
HID_BPF_STATIC_PROGRAM(huion_kamvas16_gen3, probe, sizeof(struct huion_kamvas16_gen3_state),
