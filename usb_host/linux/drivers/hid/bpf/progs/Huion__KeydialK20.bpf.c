...
static const char EXPECTED_FIRMWARE_ID[] = "HUION_T21h_";
...
struct huion_keydial_k20_state {
	__u32 last_button_state;
};
...
int BPF_PROG(k20_fix_events, struct hid_bpf_ctx *hctx)
{
	...
	struct huion_keydial_k20_state *state = hid_bpf_get_private(hctx);
...
HID_BPF_STATIC_PROGRAM(keydial_k20, probe, sizeof(struct huion_keydial_k20_state),
