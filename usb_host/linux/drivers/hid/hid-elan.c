...
static const struct hid_device_id elan_devices[] = {
	...
	// Firmware host transport is USB-only; retain upstream I2C rows inactive.
	{ }
};
MODULE_DEVICE_TABLE(hid, elan_devices);

// static struct hid_driver elan_driver = {
// Imported driver descriptors are immutable and remain in flash in this port.
static const struct hid_driver elan_driver = {
	.name = "elan",
