 ...
 */
/*
 * Port note: active MT slot/report logic stays upstream-shaped. Upstream
 * kernel-doc is kept for public helpers; lockdep/guard replacements are
...
static void __input_mt_drop_unused(struct input_dev *dev, struct input_mt *mt)
{
	...
	// FreeRTOS port has no lockdep; caller holds the port event mutex.
...
void input_mt_drop_unused(struct input_dev *dev)
{
	...
	if (mt) {
		...
		// The compatibility spinlock is a no-op; use the task-context port
		// mutex around the same upstream critical section.
