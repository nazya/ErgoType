...
{
    TUD_CONFIG_DESCRIPTOR(USB_CONFIG_NUMBER, ITF_NUM_TOTAL_HID_CDC, USB_CONFIG_STRIDX, CONFIG_TOTAL_LEN_HID_CDC, USB_CONFIG_ATTR, USB_CONFIG_POWER_MA),
    TUD_CDC_DESCRIPTOR(ITF_NUM_HID_CDC_CDC, STRID_CDC_IF, EPNUM_HID_CDC_NOTIF, USB_CDC_NOTIF_EP_SIZE, EPNUM_HID_CDC_OUT, EPNUM_HID_CDC_IN, USB_CDC_BULK_MPS_FS),
    TUD_HID_DESCRIPTOR(ITF_NUM_HID_CDC_HID, STRID_HID_IF, HID_ITF_PROTOCOL_KEYBOARD, sizeof(desc_hid_report), EPNUM_HID_CDC_HID, CFG_TUD_HID_EP_BUFSIZE, USB_HID_POLL_INTERVAL_MS),
};

static uint8_t const desc_configuration_cdc_msc[] =
{
    TUD_CONFIG_DESCRIPTOR(USB_CONFIG_NUMBER, ITF_NUM_TOTAL_CDC_MSC, USB_CONFIG_STRIDX, CONFIG_TOTAL_LEN_CDC_MSC, USB_CONFIG_ATTR, USB_CONFIG_POWER_MA),
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC_MSC_CDC, STRID_CDC_IF, EPNUM_CDC_MSC_NOTIF, USB_CDC_NOTIF_EP_SIZE, EPNUM_CDC_MSC_OUT, EPNUM_CDC_MSC_IN, USB_CDC_BULK_MPS_FS),
    TUD_MSC_DESCRIPTOR(ITF_NUM_CDC_MSC_MSC, STRID_MSC_IF, EPNUM_MSC_OUT, EPNUM_MSC_IN, USB_MSC_MPS_FS),
};
...
{
    TUD_CONFIG_DESCRIPTOR(USB_CONFIG_NUMBER, ITF_NUM_TOTAL_HID_CDC, USB_CONFIG_STRIDX, CONFIG_TOTAL_LEN_HID_CDC, USB_CONFIG_ATTR, USB_CONFIG_POWER_MA),
    TUD_CDC_DESCRIPTOR(ITF_NUM_HID_CDC_CDC, STRID_CDC_IF, EPNUM_HID_CDC_NOTIF, USB_CDC_NOTIF_EP_SIZE, EPNUM_HID_CDC_OUT, EPNUM_HID_CDC_IN, USB_CDC_BULK_MPS_HS),
    TUD_HID_DESCRIPTOR(ITF_NUM_HID_CDC_HID, STRID_HID_IF, HID_ITF_PROTOCOL_KEYBOARD, sizeof(desc_hid_report), EPNUM_HID_CDC_HID, CFG_TUD_HID_EP_BUFSIZE, USB_HID_POLL_INTERVAL_MS),
};
...
{
    TUD_CONFIG_DESCRIPTOR(USB_CONFIG_NUMBER, ITF_NUM_TOTAL_CDC_MSC, USB_CONFIG_STRIDX, CONFIG_TOTAL_LEN_CDC_MSC, USB_CONFIG_ATTR, USB_CONFIG_POWER_MA),
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC_MSC_CDC, STRID_CDC_IF, EPNUM_CDC_MSC_NOTIF, USB_CDC_NOTIF_EP_SIZE, EPNUM_CDC_MSC_OUT, EPNUM_CDC_MSC_IN, USB_CDC_BULK_MPS_HS),
    TUD_MSC_DESCRIPTOR(ITF_NUM_CDC_MSC_MSC, STRID_MSC_IF, EPNUM_MSC_OUT, EPNUM_MSC_IN, USB_MSC_MPS_HS),
};
