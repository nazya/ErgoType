...
#ifndef ERGOTYPE_USB_COMPOSITE_NKRO_KB_MOUSE
#define ERGOTYPE_USB_COMPOSITE_NKRO_KB_MOUSE 0
#endif
...
#define HID_NKRO_MOUSE_INSTANCE HID_KEYBOARD_INSTANCE
#define HID_NKRO_MOUSE_REPORT_ID REPORT_ID_MOUSE
#define HID_NKRO_WEBHID_INSTANCE HID_MOUSE_INSTANCE
#else
#define HID_NKRO_MOUSE_INSTANCE HID_MOUSE_INSTANCE
#define HID_NKRO_MOUSE_REPORT_ID 0
#define HID_NKRO_WEBHID_INSTANCE HID_WEBHID_INSTANCE
#endif
...
#define USB_CDC_BULK_MPS_HS 512
#define USB_MSC_MPS_HS 512
...
#define USB_HID_POLL_INTERVAL_HS 4
