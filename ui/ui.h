...
// 32-step ring, advanced every UI_STEP_MS by the platform UI. Bit 0 is output first.
...
// Owned and assigned by the platform UI task.
extern ui_task_handle_t ui_handle;
